...
─────────────────           ──────────────────        ─────────────
[your-org]/               [YOUR-USERNAME]/           local clone
github-for-ai-builders  ← github-for-ai-builders  ← (working directory)
        │                         │
...
git remote -v
# origin    https://github.com/YOUR-USERNAME/github-for-ai-builders.git (fetch)
# origin    https://github.com/YOUR-USERNAME/github-for-ai-builders.git (push)
# upstream  https://github.com/[your-org]/github-for-ai-builders.git (fetch)
# upstream  https://github.com/[your-org]/github-for-ai-builders.git (push)
```
...
```bash
gh repo sync YOUR-USERNAME/github-for-ai-builders --source [your-org]/github-for-ai-builders
```
...
1. Check your current remotes:
   ...
   Replace `[your-org]` with the actual organisation or username that
