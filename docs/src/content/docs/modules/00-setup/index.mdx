...
<Aside type="tip" title="How to tell you're on your fork">
  The repo header will show `YOUR-USERNAME / git-github-security-learning` with a small note underneath: *forked from fischer3-net/git-github-security-learning*. If you don't see that note, you're still on the original.
</Aside>
...
<Tabs>
  ...
  <TabItem label="Node.js">
    ...
    # 1. Clone your fork
    git clone https://github.com/YOUR-USERNAME/git-github-security-learning.git
    cd git-github-security-learning/starter-project/nodejs
